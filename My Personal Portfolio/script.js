...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("readMoreBtn").addEventListener("click", function(event) {
        ...
        if (extraInfo.style.display === "none" || extraInfo.classList.contains("hidden")) {
...
document.getElementById("readMoreContent").addEventListener("click", function(event) {
    event.preventDefault(); // Prevent the default behavior

    var extraInfo = document.getElementById("extraInformation");
